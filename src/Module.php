...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'wsl\gii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'wsl\gii\console\GenerateController',
    ...
    {
        return [
            'model2' => ['class' => 'wsl\gii\generators\model2\Generator'],
            'model' => ['class' => 'wsl\gii\generators\model\Generator'],
            'crud' => ['class' => 'wsl\gii\generators\crud\Generator'],
            'controller' => ['class' => 'wsl\gii\generators\controller\Generator'],
            'form' => ['class' => 'wsl\gii\generators\form\Generator'],
            'module' => ['class' => 'wsl\gii\generators\module\Generator'],
            'module2' => ['class' => 'wsl\gii\generators\module2\Generator'],
            'extension' => ['class' => 'wsl\gii\generators\extension\Generator'],
        ];
    }
